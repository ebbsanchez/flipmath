...
(function() {
  ...
  $(function() {
    ...
    setInterval((function() {
      return $('#textslider > ul > li:first').fadeOut(500).next().fadeIn(1000).end().appendTo('#textslider > ul');
    }), 5000);
    avatar_fix();
...
(function() {
  var lastScrollTop, mq, touch_menu;
  ...
  touch_menu = function() {
    return $('#menu-button').click(function(e) {
